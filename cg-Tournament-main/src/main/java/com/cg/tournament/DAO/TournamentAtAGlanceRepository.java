...
import com.cg.tournament.DTOs.TournamentAtAGlance;
...
public interface TournamentAtAGlanceRepository extends JpaRepository<TournamentAtAGlance, Long> {
    ...
    List<TournamentAtAGlance> getTournamentsAtAGlancewithOwnerId(@Param("userId") Long userId);
